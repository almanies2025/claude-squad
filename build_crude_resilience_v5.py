...
body(
    ...
    "by 2025 (Indian Oil Corporation Q1 2026 Earnings Call, April 15, 2026), replacing it with "
    "Saudi Arab Light, Abu Dhabi crudes, and US crude under long-term contracts. The commercial "
    "effect was to pre-position IOC's supply relationships with Saudi Aramco, Abu Dhabi National "
    "Oil Company (ADNOC), and US crude exporters — precisely the activation path used when the "
    "2026 disruption hit. Chinese state-owned refiners — Sinopec and CNPC — maintained higher "
    "Iranian exposure through intermediary arrangements, estimated at 5-7% of total Chinese "
    "crude imports in 2025 (Bloomberg data, 2025). Japanese refiners reduced Iranian imports "
    "after 2012 and maintained a broadly diversified supplier base anchored on Saudi Arabia, "
    "UAE, Kuwait, and growing US crude imports (US EIA, 2026).",
)
...
body(
    doc,
    "The mechanism matters here. Emergency crude procurement during a disruption requires three "
    ...
    "confirmed to vessel owners and port authorities. For example, a Chinese NOC activating "
    "emergency Russian crude procurement through a Eurasian banking corridor would typically "
    "require a Letter of Credit issued by a PRC policy bank (such as CDB or EXIM Bank), "
    "confirmed by a correspondent bank in Hong Kong or Singapore, with SWIFT messaging and "
    "CHIPS settlement — a sequence that processes in 3-5 business days under normal conditions "
    "and extends to 7-10 days when correspondent banks are reassessing exposure under crisis "
    "conditions. An Indian refiner activating Saudi Aramco crude through a USD-denominated "
    "contract routes the same LC through London clearing, where pre-established credit lines "
    "and CHIPS membership allow same-day or next-day settlement. The same four-layer cascade "
    "hit firms differently: capital flow architecture is the primary explanation for why, "
    "and it is a supply chain infrastructure observation — not a political one.",
)
...
body(
    ...
    "approximately $50 million at $100/barrel. The more consequential effect was capacity "
    "withdrawal: for some vessel operators, no war risk insurance capacity was available at "
    "any price for Gulf routing within the first 7-10 days. This created a functional supply "
    "disruption: crude oil was physically available, but the financial infrastructure to "
    "transport it had withdrawn. This is a tier-3 supply chain vulnerability — an insurance "
    "market disruption that cascaded upstream into physical supply before most firms detected it.",
)
...
body(
    doc,
    "The capital flow architecture context deepened this divide. IOC's alternative supply "
    "arrangements with Saudi Aramco and US exporters settled in USD through London and New "
    "York clearing hubs, where correspondent banking networks are dense and credit lines "
    "are pre-established — allowing LC issuance and settlement within 24-48 hours under "
    "crisis conditions. CNPC's emergency procurement through non-dollar corridors required "
    " correspondent relationships that had to be re-confirmed under crisis conditions — "
    "the same correspondent banking friction identified in Section 1.3, adding hours "
    "to days on top of the commercial negotiation time already lost.",
)
...
body(
    doc,
    "What the Sheffi table reveals is that the firms that managed the crisis best — "
    "IOC, Reliance Industries, and Japanese refiners — had invested in at least three of "
    "the five dimensions simultaneously. Chinese NOCs, as state-owned enterprises with "
    "complex multi-layer governance structures, scored well on organisational capabilities "
    "in normal commercial operations but found that their pre-authorised crisis protocols "
    "had not anticipated a scenario where Iranian supply was disrupted AND alternative "
    "supply required commercial re-negotiation — the take-or-pay structure had substituted "
    "for activation flexibility rather than complemented it.",
)
...
body(
    ...
    "and the mitigation instrument must match. The taxonomy also explains why inventory "
    "buffers were the most effective single investment: they address disruption risk "
    "directly by bridging the physical supply gap while activation protocols execute. "
    "And it explains why the controlled transaction — which bundles flexibility "
    "(activation without renegotiation), redundancy (pre-established alternative supply), "
    "and organisational capability (pre-authorised decision authority) into a single "
...
bullet(
    ...
    "If your primary supply route added 10 days of transit time tomorrow, would you face runout risk?",
...
bullet(
    doc,
    "Visibility layer: Do you have real-time AIS monitoring for your in-transit cargoes? "
    "Who sees this data, and what is their authorisation when they see it?",
...
bullet(
    ...
    "and pre-authorised decision authority. Without these three elements, the contract is not a "
    "controlled transaction — it is a theoretical alternative that cannot be exercised under crisis pressure.",
...
bullet(
    ...
    "but it is the most direct redundancy instrument for a disruption risk.",
    bold_prefix="Inventory layer:",
)
bullet(
    doc,
    "Refinery layer: Audit your refinery's actual crude grade flexibility using NCI and crude assay data. "
    "If your refinery is configured for specific crude types, your controlled transaction strategy must "
    "be limited to alternative suppliers delivering the grades your refinery can process.",
...
bullet(
    ...
    "in each alternative currency corridor. Pre-position correspondent banking relationships for contingency "
    "suppliers. Every hour of banking friction in your activation path is latency you cannot afford in a crisis.",
    bold_prefix="Capital flow layer:",
)
bullet(
    doc,
...
bullet(
    ...
    "For temporary disruptions: maintain controlled transaction activation, do not restructure permanently. "
...
body(
    doc,
    "The practitioner message must be nuanced: resilience architecture should be robust "
    "across multiple scenarios, not optimised exclusively for the most recent disruption. "
    "Specifically, alternative supplier contracts activated in 2026 should include "
    "sunset provisions tied to Iranian crude returning to market — and every resilience "
    "investment should be evaluated against the scenario where Iranian crude returns "
    "at scale within five years. The firms that will manage the next disruption best "
    "are those that build scenario flexibility into their supply chain infrastructure — "
    "not those that optimise for the last crisis. This is not a price story. "
    "It is a structure story.",
)
...
body(
    ...
    "taxonomy tells each investment which risk type it addresses. Choi et al.'s "
    "visibility framework tells practitioners where to look when the next crisis begins. "
    "And the capital flow architecture lens tells practitioners that activation speed "
    "is not only organisational — it is infrastructural. The correspondent banking "
    "corridors, settlement currency architecture, and cargo tracking interoperability "
    "through which emergency procurement travels are as much a part of resilience "
    "infrastructure as refinery configuration or inventory buffer.",
)

body(
    doc,
    "The structural uncertainty that shadows this entire analysis is Saudi-Iran "
    "normalisation. Architecture optimised exclusively for the 2026 scenario is fragile. "
    "The firms that will manage the next disruption best build scenario flexibility "
    "into their supply chain infrastructure — not those that optimise for the most "
    "recent one. This is a supply chain risk management story, "
